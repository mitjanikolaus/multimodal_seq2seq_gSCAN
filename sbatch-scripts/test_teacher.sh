...
# test small teacher model with LM
python -u -m seq2seq --mode=test --data_directory=data/compositional_splits --attention_type=bahdanau --no_auxiliary_task --conditional_attention --output_directory=out_teacher_lm_small_50 --resume_from_file=out_teacher_lm_small_50/model_best.pth.tar --splits=test,visual,visual_easier,situational_1,situational_2,contextual,adverb_1,adverb_2 --output_file_name=teacher_lm_small_50.json --max_decoding_steps=120 &> out_teacher_lm_small_50/test.txt
